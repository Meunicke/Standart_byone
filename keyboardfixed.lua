--[[
	Delta Mobile | Keyboard Script - VERSÃO CORRIGIDA
	CRACKED MADE BY ATA | MODIFICADO COM MELHORIAS
]]
...
-- NOVO: Botao de Configuracoes de Botoes Flutuantes
G2L["160"] = Instance.new("TextButton", G2L["2"]);
G2L["160"]["BackgroundColor3"] = Color3.fromRGB(0, 100, 255);
G2L["160"]["TextSize"] = 12;
...
G2L["160"]["Size"] = UDim2.new(0, 60, 0, 14);
G2L["160"]["Name"] = [[FloatKeySettings]];
G2L["160"]["Text"] = [[Key Config]];
G2L["160"]["Position"] = UDim2.new(0.66, 0, 0.9299998879432678, 0);
...
G2L["162"]["Thickness"] = 0.8999999761581421;
...
G2L["13c"]["Size"] = UDim2.new(0, 200, 0, 22);
G2L["13c"]["Active"] = true;
G2L["13c"]["Text"] = [[Delta Mobile - Keyboard v2.0]];
G2L["13c"]["Name"] = [[Title]];
...
-- StarterGui.DeltaKeyboard.KEY - BOTAO FLUTUANTE MELHORADO
...
G2L["140"]["CornerRadius"] = UDim.new(0, 8);
...
-- NOVO: Botao de redimensionamento (canto inferior direito)
G2L["163"] = Instance.new("TextButton", G2L["13f"]);
G2L["163"]["BackgroundColor3"] = Color3.fromRGB(100, 100, 100);
G2L["163"]["TextSize"] = 8;
...
G2L["163"]["Size"] = UDim2.new(0, 12, 0, 12);
G2L["163"]["Name"] = [[ResizeHandle]];
G2L["163"]["Text"] = [[◢]];
G2L["163"]["Position"] = UDim2.new(1, -12, 1, -12);

G2L["164"] = Instance.new("UICorner", G2L["163"]);
G2L["164"]["CornerRadius"] = UDim.new(0, 2);

-- NOVO: Botao de fixar (pin)
G2L["165"] = Instance.new("TextButton", G2L["13f"]);
G2L["165"]["BackgroundColor3"] = Color3.fromRGB(255, 200, 0);
G2L["165"]["TextSize"] = 10;
...
G2L["165"]["Size"] = UDim2.new(0, 12, 0, 12);
G2L["165"]["Name"] = [[PinButton]];
G2L["165"]["Text"] = [[P]];
G2L["165"]["Position"] = UDim2.new(0, -6, 0, -6);

G2L["166"] = Instance.new("UICorner", G2L["165"]);
G2L["166"]["CornerRadius"] = UDim.new(0, 6);
...
-- NOVO: Frame de configuracao de botoes flutuantes
G2L["167"] = Instance.new("Frame", G2L["1"]);
G2L["167"]["Active"] = true;
G2L["167"]["BackgroundColor3"] = Color3.fromRGB(32, 32, 32);
G2L["167"]["Size"] = UDim2.new(0, 300, 0, 200);
G2L["167"]["Position"] = UDim2.new(0.5, -150, 0.5, -100);
G2L["167"]["Visible"] = false;
G2L["167"]["Name"] = [[KeyConfigMenu]];

G2L["168"] = Instance.new("UICorner", G2L["167"]);
G2L["168"]["CornerRadius"] = UDim.new(0, 8);

G2L["169"] = Instance.new("UIStroke", G2L["167"]);
G2L["169"]["Color"] = Color3.fromRGB(158, 0, 255);
G2L["169"]["Thickness"] = 2;
G2L["169"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;

G2L["16a"] = Instance.new("TextLabel", G2L["167"]);
...
G2L["16a"]["Size"] = UDim2.new(1, 0, 0, 30);
G2L["16a"]["Text"] = [[Configurar Botoes Flutuantes]];
...
G2L["16b"]["FontFace"] = Font.new([[rbxasset://fonts/families/Nunito.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
G2L["16b"]["TextSize"] = 14;
G2L["16b"]["TextColor3"] = Color3.fromRGB(200, 200, 200);
G2L["16b"]["Size"] = UDim2.new(1, 0, 0, 20);
G2L["16b"]["Position"] = UDim2.new(0, 0, 0.2, 0);
G2L["16b"]["Text"] = [[Tamanho Padrao: 40x40]];
G2L["16b"]["BackgroundTransparency"] = 1;
G2L["16b"]["Name"] = [[SizeLabel]];

G2L["16c"] = Instance.new("TextButton", G2L["167"]);
G2L["16c"]["BackgroundColor3"] = Color3.fromRGB(21, 21, 21);
G2L["16c"]["TextSize"] = 16;
G2L["16c"]["FontFace"] = Font.new([[rbxasset://fonts/families/Nunito.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
G2L["16c"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
G2L["16c"]["Size"] = UDim2.new(0, 80, 0, 30);
G2L["16c"]["Text"] = [[Pequeno]];
G2L["16c"]["Position"] = UDim2.new(0.1, 0, 0.4, 0);
G2L["16c"]["Name"] = [[SmallBtn]];
...
G2L["16e"]["Size"] = UDim2.new(0, 80, 0, 30);
G2L["16e"]["Text"] = [[Medio]];
G2L["16e"]["Position"] = UDim2.new(0.4, 0, 0.4, 0);
G2L["16e"]["Name"] = [[MediumBtn]];

G2L["16f"] = Instance.new("UICorner", G2L["16e"]);
G2L["16f"]["CornerRadius"] = UDim.new(0, 5);

G2L["170"] = Instance.new("TextButton", G2L["167"]);
G2L["170"]["BackgroundColor3"] = Color3.fromRGB(21, 21, 21);
G2L["170"]["TextSize"] = 16;
G2L["170"]["FontFace"] = Font.new([[rbxasset://fonts/families/Nunito.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
G2L["170"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
G2L["170"]["Size"] = UDim2.new(0, 80, 0, 30);
G2L["170"]["Text"] = [[Grande]];
G2L["170"]["Position"] = UDim2.new(0.7, 0, 0.4, 0);
G2L["170"]["Name"] = [[LargeBtn]];

G2L["171"] = Instance.new("UICorner", G2L["170"]);
G2L["171"]["CornerRadius"] = UDim.new(0, 5);

-- Botao Fixar Todos
G2L["172"] = Instance.new("TextButton", G2L["167"]);
G2L["172"]["BackgroundColor3"] = Color3.fromRGB(255, 200, 0);
G2L["172"]["TextSize"] = 16;
...
G2L["172"]["Size"] = UDim2.new(0, 120, 0, 35);
G2L["172"]["Text"] = [[Fixar Todos]];
G2L["172"]["Position"] = UDim2.new(0.25, 0, 0.65, 0);
G2L["172"]["Name"] = [[PinAllBtn]];

G2L["173"] = Instance.new("UICorner", G2L["172"]);
G2L["173"]["CornerRadius"] = UDim.new(0, 5);

-- Botao Soltar Todos
G2L["174"] = Instance.new("TextButton", G2L["167"]);
G2L["174"]["BackgroundColor3"] = Color3.fromRGB(0, 200, 255);
G2L["174"]["TextSize"] = 16;
...
G2L["174"]["Size"] = UDim2.new(0, 120, 0, 35);
G2L["174"]["Text"] = [[Soltar Todos]];
G2L["174"]["Position"] = UDim2.new(0.25, 0, 0.85, 0);
G2L["174"]["Name"] = [[UnpinAllBtn]];

G2L["175"] = Instance.new("UICorner", G2L["174"]);
G2L["175"]["CornerRadius"] = UDim.new(0, 5);

-- Fechar menu
G2L["176"] = Instance.new("TextButton", G2L["167"]);
G2L["176"]["BackgroundColor3"] = Color3.fromRGB(255, 0, 0);
G2L["176"]["TextSize"] = 14;
...
G2L["176"]["Size"] = UDim2.new(0, 25, 0, 25);
G2L["176"]["Text"] = [[X]];
G2L["176"]["Position"] = UDim2.new(1, -30, 0, 5);
G2L["176"]["Name"] = [[CloseMenu]];
...
G2L["145"]["CornerRadius"] = UDim.new(0, 8);
...
-- NOVO: Valor para tamanho padrao dos botoes
G2L["178"] = Instance.new("IntValue", G2L["1"]);
G2L["178"]["Value"] = 40;
G2L["178"]["Name"] = [[DefaultKeySize]];
...
-- StarterGui.DeltaKeyboard.KeyConfigScript
G2L["179"] = Instance.new("LocalScript", G2L["1"]);
G2L["179"]["Name"] = [[KeyConfigScript]];
...
local function C_56()
	...
	local DefaultSize = script.Parent.Parent.Parent.DefaultKeySize
	...
	local function CreateFloatingKey(keybind, text)
		...
		-- Aplicar tamanho padrao configurado
		local size = DefaultSize.Value
		key.Size = UDim2.new(0, size, 0, size)
		
		key.Parent = script.Parent.Parent.Parent.Keys
		key.Visible = true
		
		-- Sistema de drag melhorado com suporte a pin
		...
		local function updateDrag(input)
			...
			game:GetService("TweenService"):Create(key, TweenInfo.new(0.1), {Position = position}):Play()
		end
		...
		key.InputChanged:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
				if dragToggle and not isPinned then
					updateDrag(input)
				end
			end
		end)
		...
		-- Botao de pin
		key.PinButton.MouseButton1Click:Connect(function()
			isPinned = not isPinned
			if isPinned then
				key.PinButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
				key.PinButton.Text = [[OK]]
				key.Draggable = false
			else
				key.PinButton.BackgroundColor3 = Color3.fromRGB(255, 200, 0)
				key.PinButton.Text = [[P]]
				key.Draggable = true
			end
		end)
		...
		key.ResizeHandle.InputBegan:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
				resizing = true
		...
		key.ResizeHandle.InputChanged:Connect(function(input)
			if resizing and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
				local delta = input.Position - resizeStart
				local newSize = math.max(20, math.min(100, startSize.X.Offset + delta.X))
				key.Size = UDim2.new(0, newSize, 0, newSize)
			end
		end)
...
-- StarterGui.DeltaKeyboard.Main.ButtonHandler - COOLDOWN CORRIGIDO
local function C_138()
	local script = G2L["138"];
	local buttons = script.Parent
	local ts = game.TweenService
	
	-- Cooldown melhorado usando debounce em vez de flag booleana problemática
	local windowDebounce = false
	local lastWindowClick = 0
	...
	-- Cooldown corrigido usando tempo em vez de booleana
	buttons.Window.MouseButton1Up:Connect(function()
		local currentTime = tick()
		if currentTime - lastWindowClick < 0.9 then return end
		lastWindowClick = currentTime
		
		if script.Parent.Background.Visible == true then
			script.Parent.ToggleRGB.Visible = false
			script.Parent.Settings.Visible = false
			script.Parent.FloatKeySettings.Visible = false
			...
			tw.Completed:Connect(function()
				...
				script.Parent.FloatKeySettings.Visible = true
	...
	buttons.FloatKeySettings.MouseButton1Up:Connect(function()
		script.Parent.Parent.KeyConfigMenu.Visible = true
	end)
	...
	IsSelecting:GetPropertyChangedSignal("Value"):Connect(function()
		...
		elseif IsSelecting.Value == false then
			script.Parent.Title.Text = "Delta Mobile - Keyboard v2.0"
		end
	end)
...
local function C_152()
	...
	local DefaultSize = script.Parent.Parent.DefaultKeySize
...
-- NOVO: Script de configuracao de botoes flutuantes
local function C_179()
	local script = G2L["179"];
	local menu = script.Parent.KeyConfigMenu
	local DefaultSize = script.Parent.DefaultKeySize
	local KeysFolder = script.Parent.Keys
	
	-- Fechar menu
	menu.CloseMenu.MouseButton1Click:Connect(function()
		menu.Visible = false
	end)
	
	-- Tamanhos predefinidos
	menu.SmallBtn.MouseButton1Click:Connect(function()
		DefaultSize.Value = 30
		menu.SizeLabel.Text = "Tamanho Padrao: 30x30"
	end)
	
	menu.MediumBtn.MouseButton1Click:Connect(function()
		DefaultSize.Value = 40
		menu.SizeLabel.Text = "Tamanho Padrao: 40x40"
	end)
	
	menu.LargeBtn.MouseButton1Click:Connect(function()
		DefaultSize.Value = 60
		menu.SizeLabel.Text = "Tamanho Padrao: 60x60"
	end)
	
	-- Fixar todos
	menu.PinAllBtn.MouseButton1Click:Connect(function()
		for _, key in pairs(KeysFolder:GetChildren()) do
			if key:IsA("TextButton") and key:FindFirstChild("PinButton") then
				key.PinButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
				key.PinButton.Text = [[OK]]
				key.Draggable = false
			end
	...
	-- Soltar todos
	menu.UnpinAllBtn.MouseButton1Click:Connect(function()
		for _, key in pairs(KeysFolder:GetChildren()) do
			if key:IsA("TextButton") and key:FindFirstChild("PinButton") then
				key.PinButton.BackgroundColor3 = Color3.fromRGB(255, 200, 0)
				key.PinButton.Text = [[P]]
